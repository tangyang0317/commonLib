...
import com.bqj.mall.library.commonlib.view.sku.utils.ScreenUtils;
import com.bqj.mall.library.commonlib.view.sku.utils.ViewUtils;
import com.bqj.mall.library.commonlib.view.sku.widget.FlowLayout;
...
public class SkuItemLayout extends LinearLayout {
    ...
    public void buildItemLayout(int position, String attributeName, List<String> attributeValueList, boolean clickAble) {
