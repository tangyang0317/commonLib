 ...
 * 描述:     TODO
 */
public abstract class BaseDialogFragment<P extends BasePresenter> extends RxDialogFragment implements IBaseView {
    ...
    protected <T> ObservableTransformer<T, T> reClick1() {
        return new ObservableTransformer<T, T>() {
            ...
            public ObservableSource<T> apply(Observable<T> upstream) {
                return upstream
                        .compose(BaseDialogFragment.this.<T>bindToLifecycle())
